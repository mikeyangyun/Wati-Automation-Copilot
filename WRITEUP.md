...
- **Test design.** 554 tests are mine in shape — Cursor drafted cases, I tightened invariants, added the structural-vs-semantic interaction tests, and the in-process simulation smoke harness (`pnpm --filter server simulation-smoke`).
