...
REST + JSON over two resources — **Flow** and **Simulation**. See [docs/api.md](./docs/api.md) for endpoint tables, request/response examples, status codes, and the shared error shape.
